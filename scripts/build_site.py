...
def build():
    ...
    ai_plugin = {
        ...
        "description_for_model": "Financial news API providing articles about markets, macroeconomics, and monetary policy. Articles include structured metadata, tags, sources, and are available in HTML, JSON, and Markdown formats.",
        "api": {
            "type": "openapi",
